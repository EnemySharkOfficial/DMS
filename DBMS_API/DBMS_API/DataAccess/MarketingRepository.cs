...
{
    public class MarketingRepository : IRepository<MarketingDepartmentContext>
    {
        private readonly MarketingDepartmentContext _context;
        private bool Disposed = false;
        private readonly IMapper _mapper;

        public MarketingRepository(MarketingDepartmentContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
