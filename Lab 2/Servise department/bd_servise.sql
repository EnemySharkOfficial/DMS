...
GO
CREATE TABLE [master] (
	id_master integer NOT NULL IDENTITY(1, 1),
	FIO varchar(255) NOT NULL,
	mail varchar(255) NOT NULL,
	passport_data varchar(255) NOT NULL,
...
GO
CREATE TABLE [car] (
	id_car integer NOT NULL IDENTITY(1, 1),
...
CREATE TABLE [service] (
	id_service integer NOT NULL IDENTITY(1, 1),
...
CREATE TABLE [manager] (
	id_manager integer NOT NULL IDENTITY(1, 1) ,
	FIO varchar(255) NOT NULL,
	mail varchar(255) NOT NULL,
	passport_data varchar(255) NOT NULL,
...
CREATE TABLE [current_service] (
	id_current_service integer NOT NULL IDENTITY(1, 1),
